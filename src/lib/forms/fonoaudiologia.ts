  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { type: "textarea", key: "queixa_principal", label: "Queixa/observação principal", rows: 4 },
      ],
    },
    {
      ...
      fields: [
        ...
        { type: "textarea", key: "condicoes_clinicas", label: "Condições clínicas relevantes", rows: 3 },
      ],
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        radio("uso_aparelho", "Uso do aparelho auditivo", ["Adequado", "Inadequado", "Não se aplica"]),
    ...
    },
    {
      ...
      fields: [
        { type: "checkbox", key: "risco_sem_alteracao", label: "Sem sinais de alteração fonoaudiológica no momento" },
        { type: "checkbox", key: "risco_acompanhamento", label: "Necessita acompanhamento fonoaudiológico" },
        { type: "checkbox", key: "risco_disfagia", label: "Suspeita de disfagia — necessita avaliação/conduta específica" },
        { type: "checkbox", key: "risco_broncoaspiracao", label: "Risco aumentado de broncoaspiração" },
        ...
        { type: "checkbox", key: "risco_complementar", label: "Necessita avaliação complementar/encaminhamento" },
    ...
    },
    {
      ...
      fields: [
        ...
        { type: "checkbox", key: "conduta_consistencia", label: "Adequar consistência alimentar conforme avaliação" },
        { type: "checkbox", key: "conduta_postura", label: "Orientar postura e ritmo durante alimentação" },
        { type: "checkbox", key: "conduta_avaliacao", label: "Solicitar avaliação complementar" },
        { type: "checkbox", key: "conduta_encaminhar", label: "Encaminhar para serviço/rede de saúde" },
    ...
    },
    {
      ...
      description: "Necessidades identificadas e cuidados a serem incorporados à rotina do residente.",
