...
export const nutricaoForm: FormSpec = {
  ...
  sections: [
    ...
    },
    {
      title: "II. Triagem",
      description:
        "Selecione, em cada item, o valor correspondente (0 até o valor máximo do item).",
      fields: [
        score(
          "t_a",
          "A – Diminuição da ingesta alimentar nos últimos 3 meses",
          ["0", "1", "2"],
          "0 = diminuição grave · 1 = diminuição moderada · 2 = sem diminuição",
        ),
        score(
          "t_b",
          "B – Perda de peso nos últimos meses",
          ["0", "1", "2", "3"],
          "0 = perda > 3kg · 1 = não sabe informar · 2 = perda entre 1 e 3kg · 3 = sem perda de peso",
        ),
        score(
          "t_c",
          "C – Mobilidade",
          ["0", "1", "2"],
          "0 = restrito ao leito/cadeira de rodas · 1 = deambula, não sai de casa · 2 = normal",
        ),
        score(
          "t_d",
        ...
        score(
          "t_f",
          "F – Índice de Massa Corpórea (IMC = peso / estatura²)",
          ["0", "1", "2", "3"],
    ...
    },
    {
      ...
      fields: [
        ...
        score(
          "g_h",
          "H – Utiliza mais de 3 medicamentos diferentes por dia",
          ["0", "2"],
          "0 = sim · 2 = não",
        ),
        ...
        score(
          "g_k1",
          "K1 – Consome ao menos uma porção diária de leite ou derivados",
          ["0", "1"],
          "0 = não · 1 = sim",
        ),
        score(
          "g_k2",
          "K2 – Consome duas ou mais porções semanais de leguminosas ou ovos",
          ["0", "1"],
          "0 = não · 1 = sim",
        ),
        score(
          "g_k3",
          "K3 – Consome carne, peixe ou aves todos os dias",
          ["0", "1"],
          "0 = não · 1 = sim",
        ),
        score(
          "g_k",
          "K – Escore de consumo proteico (baseado em K1+K2+K3)",
          ["0", "0,5", "1"],
          "0,0 = nenhuma/uma resposta sim · 0,5 = duas respostas sim · 1,0 = três respostas sim",
        ),
        score(
          "g_l",
          "L – Consome duas ou mais porções diárias de frutas ou vegetais",
          ["0", "1"],
          "0 = não · 1 = sim",
        ),
        score(
          "g_m",
          "M – Quantos copos de líquidos consome por dia",
          ["0", "0,5", "1"],
        ...
        score(
          ...
          ["0", "1", "2"],
          "0 = não é capaz sozinho · 1 = sozinho, com dificuldade · 2 = sozinho, sem dificuldade",
        ),
        score(
          "g_o",
          "O – O paciente acredita ter algum problema nutricional",
          ["0", "1", "2"],
          "0 = acredita estar desnutrido · 1 = não sabe dizer · 2 = acredita não ter problema",
        ),
        score(
          "g_p",
          "P – Em comparação a outras pessoas da mesma idade, como considera sua saúde",
          ["0", "0,5", "2"],
          "0,0 = não muito boa · 0,5 = não sabe informar · 2,0 = melhor",
        ),
        score(
          "g_q",
      ...
      fields: [
        {
          type: "computed",
          key: "final_triagem",
          label: "Escore da Triagem (máximo 14 pontos)",
          sum: ["t_total"],
        },
        {
          type: "computed",
          key: "final_global",
          label: "Escore da Avaliação Global (máximo 16 pontos)",
          sum: ["g_total"],
        },
        {
          type: "computed",
