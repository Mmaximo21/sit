  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        { type: "textarea", key: "hpp_lista", label: "Doenças/condições", rows: 3 },
        {
          type: "textarea",
          key: "hpp_descricao",
          label: "Descrição clínica do período avaliado",
          rows: 6,
        },
      ],
    },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          type: "sided",
          key: "olhos_lentes",
          label: "Uso de lentes corretivas",
          sides: ["Direito", "Esquerdo"],
          options: SIM_NAO,
        },
        {
          type: "sided",
          key: "olhos_snellen",
          label: "Teste de Snellen",
          sides: ["Direito", "Esquerdo"],
          options: ["< 0,3", "> 0,3"],
        },
        {
          type: "text",
          key: "olhos_ultima_visita",
          label: "Data da última visita ao oftalmologista",
        },
        { type: "textarea", key: "olhos_obs", label: "Observação", rows: 2 },
        { type: "note", key: "nota_orelha", label: "Orelha" },
        {
          type: "sided",
          key: "orelha_def_auditiva",
        ...
        },
        {
          type: "sided",
          key: "orelha_sussurro",
          label: "Teste do sussurro (60cm de cada ouvido)",
          sides: ["Direito", "Esquerdo"],
          options: ["Positivo", "Negativo"],
        },
        {
          type: "sided",
          key: "orelha_conversacao",
          label: "Dificuldades para conversação com 3 ou mais pessoas",
          sides: ["Direito", "Esquerdo"],
          options: SIM_NAO,
        },
        {
          type: "text",
          key: "orelha_ultima_visita",
          label: "Data da última visita ao otorrinolaringologista",
        },
    ...
    },
    {
      ...
      fields: [
        ...
        {
          type: "textarea",
          key: "cv_caracteristicas",
          label: "Especificar característica de sintoma positivo",
          rows: 2,
        },
      ],
    },
    ...
    },
    {
      ...
      fields: [
        simNao("gu_incontinencia", "Incontinência urinária"),
        {
          type: "radio",
          key: "gu_incont_tempo",
          label: "Tempo da incontinência",
          options: ["Recente < 30 dias", "Crônica > 30 dias"],
        },
        {
          type: "radio",
          key: "gu_incont_limite",
          label: "Grau",
          options: ["Limitante", "Não limitante"],
        },
    ...
    },
    {
      ...
      fields: [
        ...
        simNao("sn_tremores", "Tremores"),
        {
          type: "radio",
          key: "sn_tremor_tipo",
          label: "Tipo de tremor",
          options: ["Repouso", "Cinético", "Indeterminado", "Misto"],
        },
    ...
    },
    {
      ...
      fields: [
        ...
        {
          type: "radio",
          key: "resp_tosse_duracao",
          label: "Duração da tosse",
          options: ["> 4 semanas", "< 4 semanas"],
        },
        {
          type: "radio",
          key: "resp_tosse_tipo",
          label: "Tipo de tosse",
          options: ["Seca", "Produtiva"],
        },
    ...
    },
    {
      ...
      fields: [
        ...
        { type: "textarea", key: "oral_caracteristicas", label: "Características", rows: 2 },
        {
          type: "textarea",
          key: "hospitalizacoes",
          label: "Hospitalizações clínicas (diagnóstico/ano)",
          rows: 3,
        },
      ],
    },
